        ...
        <div className="content-stretch flex flex-col gap-[20px] items-start p-[16px] relative w-full">
          ...
          >
            ...
            <div
              ...
              style={{
                boxShadow:
                  "0px 10px 24px -10px rgba(139,26,43,0.12), 0px 18px 40px -12px rgba(0,0,0,0.2)",
              }}
            />
          </button>
