    ...
    <div className="bg-gradient-to-b content-stretch flex flex-col from-[#07111f] items-start overflow-hidden relative size-full to-[#0a1628]">
      ...
      <div className="content-stretch flex flex-col gap-[24px] items-start pt-[56px] px-[24px] relative shrink-0 w-full">
        ...
        <div className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0 w-full">
          ...
          <p className="font-['Young_Serif:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[28px] text-center text-white">
            Benchmark Bank
          </p>
        </div>
        ...
        <div className="content-stretch flex flex-col gap-[8px] items-center relative shrink-0 w-full">
          ...
          <p className="font-['Geist:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#94a3b8] text-[14px]">
        ...
        <div
          ...
          style={{ boxShadow: "0px 18px 20px rgba(0,0,0,0.4)" }}
        >
          <div
            aria-hidden
          ...
          <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
            <p className="font-['Geist:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[#94a3b8] text-[12px] tracking-[0.24px] uppercase">
              Username
            </p>
          ...
          <div className="content-stretch flex items-center justify-between py-[4px] relative shrink-0 w-full">
            <div className="content-stretch flex gap-[10px] items-center relative shrink-0">
              ...
              <p className="font-['Geist:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#e5e7eb] text-[13px]">
                Remember me
              </p>
            </div>
          ...
          <div className="content-stretch flex flex-col gap-[12px] items-start pt-[16px] relative shrink-0 w-full">
            ...
            <button className="bg-transparent content-stretch cursor-pointer flex h-[52px] items-center justify-center relative rounded-[14px] shrink-0 w-full border-[1.5px] border-[#8b1a2b] border-solid">
              <p className="font-['Geist:SemiBold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[16px] text-[#8b1a2b]">
                Use other Account
              </p>
            </button>
          </div>
      ...
      <div className="content-stretch flex flex-col gap-[12px] items-center pb-[24px] pt-[8px] relative shrink-0 w-full mt-auto">
        <p className="font-['Geist:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#94a3b8] text-[14px]">
          Forgot Username?
        </p>
